...
The results from the graph shows us that self control and materialism do affect people's spending habits, at least to some extent. Impulsivity plays a larger role than materialism (see: the gaps between the lines), which is also shown by our other models and their results.
